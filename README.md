...
3. [CSU Center for Public History + Digital Humanities](https://csudigitalhumanities.org/) for the [Tour Builder](https://github.com/CPHDH/Curatescape/tree/master/plugins/TourBuilder) plugin.
