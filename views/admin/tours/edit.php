...
echo head(array(
  ...
  'bodyclass' => 'tours primary edit add-tour-form',
  'bodyid' => 'tour'
));
echo flash();
?>
...
<form method="post" enctype="multipart/form-data" id="tour-form" action="">
  ...
  <section class="three columns omega tour-form-sidebar" id="tour-editor-control-panel">
    <div id="save" class="panel">
      ...
      <a href="<?php echo html_escape(public_url('walking-tour') . '?tourId=' . $walking_tour->id); ?>"
