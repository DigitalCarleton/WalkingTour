...
<section class="seven columns alpha" id="edit-form">
	...
	<div id="tour-metadata">
		<div id="form-data">
			...
			<fieldset>
				...
				<div class="field">
					...
					<div class="five columns omega inputs">
						...
						<p class="explanation">
							<?php echo __('OPTIONAL: The name of the person(s) or organization responsible for the content of the tour.'); ?>
						</p>
					</div>
				</div>
				...
				<div class="field">
					...
					<div class="five columns omega inputs">
						...
						<p class="explanation">
							<?php echo __('OPTIONAL: Add postscript text to the end of the tour, for example, to thank a sponsor or add directional information.'); ?>
						</p>
					</div>
				</div>
				...
				<div class="field">
					...
					<div class="five columns omega inputs">
						...
						<p class="explanation">
							<?php echo __('Add a HTML color code as a hexadecimal value for the color shown in the map.'); ?>
						</p>
					</div>
				</div>
			...
			<script>
				window.currentTour = <?php echo $walking_tour->id ? (int) $walking_tour->id : 'null'; ?>;
			</script>
			...
			<fieldset id="tour-items-picker">
				...
				<div class="input-container">
					<input type="search" id="tour-item-search" placeholder="Search item by title..."
